...
class UserAdmin(AllObjectsMixin, AllObjectsForeignKeyMixin, BaseUserAdmin):
    fieldsets = (
        (None, {'fields': ('pk', 'username', 'email', 'nickname', 'twitter_id', 'facebook_id', 'password',)}),
    ...
    search_fields = ('username', 'email', 'nickname', 'twitter_id', 'facebook_id', 'first_name', 'last_name', 'comment',)
    ordering = ('-last_login',)
