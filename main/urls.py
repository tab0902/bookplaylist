...
urlpatterns = [
    ...
    path('playlists/create/book/<book>/', views.PlaylistCreateBookStoreView.as_view(), name='playlist_create_book_store'),
    ...
    path('playlists/<uuid:pk>/update/book/<book>/', views.PlaylistUpdateBookStoreView.as_view(), name='playlist_update_book_store'),
