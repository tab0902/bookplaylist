...
urlpatterns = [
    ...
    path('playlist/create/book/<uuid:book>/delete/', views.PlaylistCreateBookDeleteView.as_view(), name='playlist_create_book_delete'),
    ...
    path('playlist/<slug:category>/<uuid:pk>/update/book/<uuid:book>/delete/', views.PlaylistUpdateBookDeleteView.as_view(), name='playlist_update_book_delete'),
